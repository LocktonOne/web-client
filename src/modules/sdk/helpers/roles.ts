import type { FlattenRole, Permission, RoleWithResourcesFragment } from '../types'

export const formatRoleFromGraph = (graphRole: RoleWithResourcesFragment): FlattenRole => {
  let roleName = ''
  let roleDescription = ''
