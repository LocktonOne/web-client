...
export type GetConstantsPaginatedQuery = {
  __typename?: 'Query'
  constants: Array<{ __typename?: 'Constant'; id: string; value: any }>
}
...
export type GetConstantsByIdPaginatedQuery = {
  __typename?: 'Query'
  constants: Array<{ __typename?: 'Constant'; id: string; value: any }>
}
...
export type GetMasterContractRegistryAddressQuery = {
  __typename?: 'Query'
  globals: Array<{ __typename?: 'Global'; masterContractsRegistry: any }>
}

export type GetCoreContractsQueryVariables = Exact<{ [key: string]: never }>

export type GetCoreContractsQuery = {
  __typename?: 'Query'
  contracts: Array<{ __typename?: 'Contract'; id: string; address: any; isProxy: boolean }>
}
...
export type GetGlobalQuery = {
  __typename?: 'Query'
  global?: { __typename?: 'Global'; masterContractsRegistry: any } | null
}
...
export type GetKycRequestsQuery = {
  __typename?: 'Query'
  requests: Array<{
    __typename?: 'Request'
    id: string
...
export type GetKycRequestByIdQuery = {
  __typename?: 'Query'
  request?: {
    __typename?: 'Request'
    id: string
...
export type GetKycRequestsByAddressQuery = {
  __typename?: 'Query'
  requests: Array<{
    __typename?: 'Request'
    id: string
...
export type GetKycRequestsByAddressAndStatusQuery = {
  __typename?: 'Query'
  requests: Array<{
    __typename?: 'Request'
    id: string
...
export type GetUserKycRequestsByStatusQuery = {
  __typename?: 'Query'
  requests: Array<{
    __typename?: 'Request'
    id: string
...
export type RequestCommonFieldsFragment = {
  __typename?: 'Request'
  id: string
  requestId: any
  creator: any
...
export type GetRolesWithResourcesQuery = {
  __typename?: 'Query'
  roles: Array<{
    __typename?: 'Role'
    id: string
...
export type RoleWithResourcesFragment = {
  __typename?: 'Role'
  id: string
  description: string
  resources: Array<{
...
export type GetUsersByIdPaginatedQuery = {
  __typename?: 'Query'
  users: Array<{
    __typename?: 'User'
    id: any
    roles: Array<{ __typename?: 'Role'; id: string; description: string }>
  }>
}
...
export type GetUsersByRoleIdsPaginatedQuery = {
  __typename?: 'Query'
  users: Array<{
    __typename?: 'User'
    id: any
...
export type UserCommonFieldsFragment = {
  __typename?: 'User'
  id: any
  roles: Array<{ __typename?: 'Role'; id: string; description: string }>
}

export type Terc20CommonFragment = {
  __typename?: 'TERC20'
  id: any
  name: string
  symbol: string
...
export type GetTerc20SByNameQuery = {
  __typename?: 'Query'
  terc20S: Array<{
    __typename?: 'TERC20'
    id: any
...
export type Terc721CommonFragment = {
  __typename?: 'TERC721'
  id: any
  name: string
  symbol: string
...
export type GetTerc721SByNameQuery = {
  __typename?: 'Query'
  terc721S: Array<{
    __typename?: 'TERC721'
    id: any
...
export type GetTerc20SByNamePaginatedQuery = {
  __typename?: 'Query'
  terc20S: Array<{
    __typename?: 'TERC20'
    id: any
...
export type GetTerc721SByNamePaginatedQuery = {
  __typename?: 'Query'
  terc721S: Array<{
    __typename?: 'TERC721'
    id: any
...
export const GetConstantsByIdPaginated = gql`
  query getConstantsByIdPaginated($id: ID!, $offset: Int, $limit: Int) {
    constants(where: { id: $id }, first: $limit, skip: $offset, orderBy: id, orderDirection: desc) {
      ...constant
    }
  }
  ${Constant}
...
export const GetKycRequestsByAddressAndStatus = gql`
  query getKycRequestsByAddressAndStatus($address: String!, $status: BigInt!) {
    requests(where: { misc: $address, status: $status }, orderBy: requestId, orderDirection: desc) {
      ...requestCommonFields
    }
  }
  ${RequestCommonFields}
...
export const GetUserKycRequestsByStatus = gql`
  query getUserKycRequestsByStatus($misc: String!, $status: BigInt!) {
    requests(where: { misc: $misc, status: $status }, orderBy: requestId, orderDirection: desc) {
      ...requestCommonFields
    }
  }
  ${RequestCommonFields}
